...
import { Card, CardImg, CardText, CardBody, CardTitle,Modal,ModalHeader,ModalBody,BreadcrumbItem,Breadcrumb,Button,Row,Col,Label } from "reactstrap";
           ...
           comments.map(comment => (
             <ul key={comment.id} className="list-unstyled">
               ...
               <div>
                ...
                <p> --{comment.author}, {" "}
                 {
                   new Intl.DateTimeFormat("ens-US",{
                     year:"numeric",
                     month:"short",
                     day:"2-digit"
